...
public class Art
{
    ...
    public static void init(GraphicsConfiguration gc, SonarSoundEngine sound)
    {
        try
        {
            mario = cutImage(gc, "../gfx/mariosheet.png", 32, 32);
            smallMario = cutImage(gc, "../gfx/smallmariosheet.png", 16, 16);
            fireMario = cutImage(gc, "../gfx/firemariosheet.png", 32, 32);
            enemies = cutImage(gc, "../gfx/enemysheet.png", 16, 32);
            items = cutImage(gc, "../gfx/itemsheet.png", 16, 16);
            level = cutImage(gc, "../gfx/mapsheet.png", 16, 16);
            map = cutImage(gc, "../gfx/worldmap.png", 16, 16);
            particles = cutImage(gc, "../gfx/particlesheet.png", 8, 8);
            bg = cutImage(gc, "../gfx/bgsheet.png", 32, 32);
            logo = getImage(gc, "../gfx/logo.gif");
            titleScreen = getImage(gc, "../gfx/title.gif");
            font = cutImage(gc, "../gfx/font.gif", 8, 8);
            endScene = cutImage(gc, "../gfx/endscene.gif", 96, 96);
            gameOver = cutImage(gc, "../gfx/gameovergost.gif", 96, 64);
        ...
        try
        {
            ...
            sequencer.open();
            songs[0] = MidiSystem.getSequence(new File("../mus/smb3map1.mid"));
            songs[1] = MidiSystem.getSequence(new File("../mus/smwovr1.mid"));
            songs[2] = MidiSystem.getSequence(new File("../mus/smb3undr.mid"));
            songs[3] = MidiSystem.getSequence(new File("../mus/smwfortress.mid"));
            songs[4] = MidiSystem.getSequence(new File("../mus/smwtitle.mid"));
        }
        catch (Exception e)
        {
            sequencer = null;
    ...
    {
    	BufferedImage source = ImageIO.read(new File(imageName));
