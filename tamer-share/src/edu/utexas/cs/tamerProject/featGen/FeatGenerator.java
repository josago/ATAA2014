...
//	public Random randGenerator = new Random();
	...
	public static ArrayList<int[]> possActIntArrays;//uncomment by Guangliang
	public static ArrayList<Action> possStaticActions = new ArrayList<Action>();//uncomment by Guangliang
	public static ArrayList<Action> forbiddenActions = new ArrayList<Action>();//uncomment by Guangliang
