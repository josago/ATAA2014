...
//		this.hRewCounter = 0;
    ...
    private void setModel() {
    	...
    	else if (this.params.modelClass.equals("NeuralNet"))
    	{
    		...
    		this.model = new NeuralNet(this.featGen.getNumFeatures(), this.featGen.getNumFeatures() / ParamsATAA.hiddenNodesNeuralNet); // TODO: Decide on the number of hidden units.
    	...
    	else if (this.params.modelClass.equals("NeuralNetWorldModel"))
    	{
    		...
    		this.model = new NeuralNetWorldModel(this.featGen.getNumFeatures(), this.featGen.getActionFeatIndices().length, this.featGen.getNumFeatures() / ParamsATAA.hiddenNodesNeuralNet);
    		this.model.setFeatGen(this.featGen);
    	}
    	else {
...
//		double[]policyWeights =((IncGDLinearModel)this.model).weights;
//		for(int i=0;i<policyWeights.length;i++)
//		{
//		  System.out.println("policyWeights:"+i+policyWeights[i]);
//		}
		if (verbose)
