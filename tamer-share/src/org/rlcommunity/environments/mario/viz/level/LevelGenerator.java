...
public class LevelGenerator
{
    ...
    protected int buildHillStraight(int xo, int maxLength)
    {
        ...
        addEnemyLine(xo + 1, xo + length - 1, floor - 1);//guangliang comment, remove all enemies
        ...
        while (keepGoing)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    addEnemyLine(xxo, xxo + l, h - 1);//guangliang comment, remove all enemies
    ...
    protected void decorate(int x0, int x1, int floor)
    {
        ...
        addEnemyLine(x0 + 1, x1 - 1, floor - 1);//guangliang comment, remove all enemies
